...
export const roundRules: Partial<Record<RoundKey, RoundRuleSet>> = {
  round1: {
    ...
    rules: [
      'દરેક સાચા જવાબ માટે ૫ ગુણ (+5) મળશે.',
      'ખોટા જવાબ માટે ૦ ગુણ (0) મળશે.',
  ...
  round2: {
    ...
    rules: [
      'દરેક સાચા જવાબ માટે ૧૦ ગુણ (+10) મળશે.',
      'દરેક ખોટા જવાબ માટે -૫ ગુણ (-5) કપાશે.',
      'દરેક ટીમને ૨ પ્રશ્નો પૂછવામાં આવશે.',
  ...
  round3: {
    ...
    rules: [
      'દરેક સાચા જવાબ માટે ૨૦ ગુણ (+20) મળશે.',
      'દરેક ખોટા જવાબ માટે -૧૦ ગુણ (-10) કપાશે.',
